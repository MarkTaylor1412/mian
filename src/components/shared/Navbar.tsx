...
const Navbar = () => {
  return (
    <div className="glassmorphism fixed left-0 top-0 z-20 flex h-24 w-full flex-row items-center justify-between gap-3 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
      {/* //# LEFT */}
      <div className="flex w-64 flex-row items-center justify-start md:hidden lg:block">
        <Link href={"/"}>
          <ScrambleText
            text="Mian"
      ...
      {/* //# CENTRE */}
      <div className="flex-end hidden w-full flex-row gap-2 text-sm md:flex">
        ...
        <div className="hidden items-center rounded-xl bg-input p-2 shadow-md xl:flex">
          <Searchbar />
        </div>
      </div>

      {/* //# RIGHT */}
      <div className="flex w-fit flex-row items-center justify-end gap-4 xl:gap-8">
        <ClerkLoading>
          {/* <Loader /> */}
